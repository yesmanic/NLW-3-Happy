// create map
const map = L.map('mapid').setView([-23.5534242,-46.5978362], 16);
...
function addPhotoField() {
    ...
    // realizar o clome da ultima image adicionada;
...
function validate() {
    ...
    const needsLatAndLng = (inputLat!=0&&inputLng!=0)?false:true;
    if(needsLatAndLng) {
